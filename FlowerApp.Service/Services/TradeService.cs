...
//     }
//
//     public async Task<GetTradesResponse> Get(Pagination pagination, string? location, int? userId)
//     {
//         var trades = (await tradeStorage.Get(pagination, location, userId)).ToList();
//
