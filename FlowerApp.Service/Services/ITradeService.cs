...
public interface ITradeService
{
    ...
    Task<TradeResponse> GetOtherUsersTrades(Pagination pagination, string? location, int? id);
    Task<TradeResponse> GetUserTrades(Pagination pagination, string? location, int id);
