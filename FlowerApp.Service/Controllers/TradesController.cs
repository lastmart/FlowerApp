...
public class TradesController : ControllerBase
{
    ...
    /// <summary>
    ///     Получение всех трейдов с фильтрацией по городу
    /// </summary>
    /// <param name="pagination">Параметры пагинации</param>
    /// <param name="location">Город для фильтрации (опционально)</param>
    /// <returns>Список всех трейдов с общим количеством</returns>
    [HttpGet]
    public async Task<ActionResult<IRepositoryOperationStatus>> GetAllTrades(
        [FromQuery] Pagination pagination,
        [FromQuery] string? location = null)
    {
        var response = await tradeService.GetAllTrades(pagination, location);
